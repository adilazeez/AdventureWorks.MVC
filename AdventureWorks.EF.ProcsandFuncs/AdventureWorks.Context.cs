...
namespace AdventureWorks.EF.ProcsandFuncs
{
    using System;
    ...
    public partial class AdventureWorksProcsandFuncsEntities : DbContext
    {
        public AdventureWorksProcsandFuncsEntities()
            : base("name=AdventureWorksProcsandFuncsEntities")
        {
        }
